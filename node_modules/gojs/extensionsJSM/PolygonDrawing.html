...
document.getElementById("allowResizing").onclick = () => { myDiagram.allowResize = !myDiagram.allowResize; updateAllAdornments(); };
document.getElementById("allowReshaping").onclick = () => { myDiagram.allowReshape = !myDiagram.allowReshape; updateAllAdornments(); };
document.getElementById("allowResegmenting").onclick = () => { toggleResegmenting(); };
document.getElementById("allowRotating").onclick = () => { myDiagram.allowRotate = !myDiagram.allowRotate; updateAllAdornments(); };
