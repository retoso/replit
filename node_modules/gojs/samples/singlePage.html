    ...
    $(go.TextBlock, name,
      {
        ...
        alignment: go.Spot.TopLeft, margin: new go.Margin(2, 0, 16, 2),
        stroke: "gray", font: "9pt sans-serif", isMultiline: false
      }),
    $(go.TextBlock,
      {
        row: row, column: col, columnSpan: span,
        alignment: go.Spot.Center, margin: new go.Margin(16, 4, 1, 4),
...
function makeSeparator(row, col) {
  return $(go.Shape, "LineV",
    { row: row, column: col, width: 0, stretch: go.GraphObject.Vertical, stroke: "gray" });
}
  ...
  $(go.Part, "Auto",
    {
      ...
      deletable: false, movable: false, copyable: false,
